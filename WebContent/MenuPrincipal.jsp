    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
				...
				%>
                <a class="navbar-brand" href="index.html"><p>Bienvenido(a) <span class="text-capitalize"><%=objetousuario.getTrabajador().getTrabajadorbienvenida()%></span></p></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
               ...
               <!--  <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <%=objetousuario.getTrabajador().getNombre()%> <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="<%="#"+menuDTO.getIdmenu() %>"><i class="<%=menuDTO.getTipografia() %>"></i> <%=menuDTO.getDescripcion()%> <i class="fa fa-fw fa-caret-down"></i></a>
