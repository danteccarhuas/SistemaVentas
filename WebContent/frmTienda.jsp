...
<title>.: Sistema Ventas - Mantenimiento Tienda</title>
</head>
<body>
	<div id="wrapper">
							...
							<div class="panel-heading">
								<ul class="nav nav-tabs">
									<li class="active"><a href="#tab1primary" id="tab1"
										data-toggle="tab">Consulta Tienda</a></li>
									<li id="eventotab2primary" class="disabled"><a id="tab2"
										href="#tab2primary" data-toggle="tab">Datos Tienda</a></li>
								</ul>
							</div>
							<div class="panel-body">
								<div class="tab-content">
									...
									<div class="tab-pane fade" id="tab2primary">
										<br>
										<form class="form-horizontal" id="frm_tienda">
											<input type="hidden" id="hiddencodtienda" value="0"
												name="hiddencodtienda" /> <input type="hidden"
										...
										hiddenindaccion : 2 Modificar
										 -->
											...
											<div class="row">
												...
												<div class="col-lg-12">
													<div class="form-group">
														<label class="control-label col-lg-3" for="nombre">Direccion:</label>
														<div class="col-lg-8">
															<input class="form-control" type="text"
																id="txt_direccion_guardar" name="txt_direccion_guardar"
...
<script src="js/function-tienda.js"></script>
</html>